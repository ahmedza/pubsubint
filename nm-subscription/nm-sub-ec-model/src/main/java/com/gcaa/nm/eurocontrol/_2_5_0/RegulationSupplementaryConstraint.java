...
/**
 * <p>Java class for RegulationSupplementaryConstraint complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="RegulationSupplementaryConstraint"&gt;
 *   &lt;complexContent&gt;
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *       &lt;sequence&gt;
 *         &lt;element name="constraintPeriod" type="{eurocontrol/cfmu/b2b/CommonServices}DateTimeMinutePeriod"/&gt;
 *         &lt;element name="supplementaryRate"&gt;
 *           &lt;simpleType&gt;
...
@XmlType(name = "RegulationSupplementaryConstraint", propOrder = {
    "constraintPeriod",
    "supplementaryRate"
})
public class RegulationSupplementaryConstraint {

    @XmlElement(required = true)
    protected DateTimeMinutePeriod constraintPeriod;
    protected int supplementaryRate;
    ...
    /**
     * Gets the value of the supplementaryRate property.
     * 
     */
    public int getSupplementaryRate() {
        return supplementaryRate;
    }

    /**
     * Sets the value of the supplementaryRate property.
     * 
     */
    public void setSupplementaryRate(int value) {
        this.supplementaryRate = value;
    }
